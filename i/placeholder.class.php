...
class Placeholder {
	...
	function render() {
		if ($this->width <= $this->maxWidth && $this->height <= $this->maxHeight) {
			$cachePath = $this->cacheDir . '/' . $this->width . '_' . $this->height . '_' . (strlen($this->bgColor) === 3 ? $this->bgColor[0] . $this->bgColor[0] . $this->bgColor[1] . $this->bgColor[1] . $this->bgColor[2] . $this->bgColor[2] : $this->bgColor) . '_' . (strlen($this->textColor) === 3 ? $this->textColor[0] . $this->textColor[0] . $this->textColor[1] . $this->textColor[1] . $this->textColor[2] . $this->textColor[2] : $this->textColor) . '.png';
			...
			if ($this->cache === TRUE && is_readable($cachePath)) {
				...
				// convert bgColor hex to RGB values
				list($bgR, $bgG, $bgB) = $this->hexToDec($this->bgColor);
